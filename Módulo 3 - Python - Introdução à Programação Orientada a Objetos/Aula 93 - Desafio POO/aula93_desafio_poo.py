...
cliente1 = Cliente('Eduarda', 22)
cliente2 = Cliente('Francisco', 43)
cliente3 = Cliente('Joana', 31)

conta1 = ContaCorrente(1111, 1234, 1000, 200)
conta2 = ContaPoupanca(2222, 5678, 2000)
conta3 = ContaCorrente(3333, 9876, 10960, 2000)
